...
class BaseOOFTrainerV2:
    ...
    def train_epoch(self, epoch):
        ...
        for batch in tqdm(self.train_loader, desc=f"Epoch {epoch + 1} Training", leave=False):
            ...
            # Update the learning rate if the scheduler is batch based
    ...
    def train_epoch_with_accumulation(self, epoch):
        ...
        for i, batch in enumerate(tqdm(self.train_loader, desc=f"Epoch {epoch + 1} Training", leave=False)):
            ...
            # Update weights every N steps or on last batch
            ...
            # Accumulate actual (unscaled) loss for logging
